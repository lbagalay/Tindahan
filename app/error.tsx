  ...
  return (
    <div className="grid min-h-[70vh] place-items-center px-4">
      <div className="w-full max-w-sm rounded-xl border border-[var(--border)] bg-white p-6 text-center shadow-sm">
        ...
        <p className="mt-1.5 text-sm text-slate-500">This screen hit an unexpected error. Your data is safe — try again, and if it keeps happening, refresh the page.</p>

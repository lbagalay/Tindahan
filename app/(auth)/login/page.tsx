    ...
    <main className="grid min-h-screen bg-white lg:grid-cols-[1.05fr_0.95fr]">
      <section className="relative hidden overflow-hidden bg-[#123d2e] px-14 py-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3">
          <span aria-label="Tindahan logo" className="size-10 rounded-lg bg-white bg-no-repeat shadow-sm" style={tindahanLogoStyle} />
        ...
        <div className="relative max-w-xl pb-12">
          ...
          <h1 className="text-5xl font-bold leading-[1.08] tracking-[-0.04em]">Everything your business needs, right at the counter.</h1>
      ...
      <section className="flex items-center justify-center bg-[#f8faf9] px-6 py-12">
        <div className="w-full max-w-[420px]">
          <div className="mb-10 flex items-center gap-3 lg:hidden">
            ...
            <p className="text-lg font-bold text-slate-900">Tindahan</p>
          </div>
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--brand)]">Welcome back</p>
          <h2 className="mt-2 text-3xl font-bold tracking-[-0.035em] text-slate-950">Sign in to your workspace</h2>
          <p className="mt-2 text-sm leading-6 text-slate-500">Use your business account to continue.</p>

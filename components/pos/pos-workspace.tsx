    ...
    <div className="pos-warm -m-4 flex min-h-[calc(100vh-72px)] flex-col sm:-m-6 lg:-m-8 xl:flex-row">
      <section className="min-w-0 flex-1 border-r border-[var(--pos-border)] p-4 sm:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 rounded-full border border-[var(--pos-border)] bg-[var(--pos-surface)] px-3 py-1.5 text-xs text-[var(--pos-muted)]"><span className="size-2 rounded-full bg-emerald-500" /> Register online <span className="text-[var(--pos-border)]">·</span> {business.cashierName}</div>
        </div>
